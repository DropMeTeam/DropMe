...
export default function TrainTimetablesPage() {
  ...
  async function saveTimetable() {
    ...
    try {
      // backend expects departureTime required
      for (const d of DAYS) {
      ...
      // ✅ This requires backend patch to persist weeklyTimetable
          ...
          {schedules.map((sc) => (
            <div
              ...
              style={{
                ...
                borderRadius: 14,
                padding: 12,
                background: String(selectedId) === String(sc._id) ? "#f7f7f7" : "transparent",
                cursor: "pointer",
              }}
